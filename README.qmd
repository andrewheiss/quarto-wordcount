...
Install the extension in an already-existing project by running this in your terminal:
...
Or as another option, install the extension like normal, but don't use the `wordcount-html` format and instead refer to the Lua filters that live in the extension folder:
